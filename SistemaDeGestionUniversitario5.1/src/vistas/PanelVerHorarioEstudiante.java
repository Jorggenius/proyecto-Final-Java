...
//        cursosE = controlPVH.conseguirCursosEstudiante(estudiante);
    ...
    private void llenarTablaHorarioLunes() {
        ArrayList<Horario> horarioLunes = controlPVH.conseguirHorarioLunes(controlPVH.cursosLunes(controlPVH.getCursosE()));
    ...
    private void llenarTablaHorarioMartes() {
        ArrayList<Horario> horarioMartes = controlPVH.conseguirHorarioMartes(controlPVH.cursosMartes(controlPVH.getCursosE()));
    ...
    private void llenarTablaHorarioMiercoles() {
        ArrayList<Horario> horarioMiercoles = controlPVH.conseguirHorarioMiercoles(controlPVH.cursosMiercoles(controlPVH.getCursosE()));
    ...
    private void llenarTablaHorarioJueves() {
        ArrayList<Horario> horarioJueves = controlPVH.conseguirHorarioJueves(controlPVH.cursosJueves(controlPVH.getCursosE()));
    ...
    private void llenarTablaHorarioViernes() {
        ArrayList<Horario> horarioViernes = controlPVH.conseguirHorarioViernes(controlPVH.cursosViernes(controlPVH.getCursosE()));
