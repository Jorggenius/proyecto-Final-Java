...
//                            .equals(cursosLab.get(i).getHorario1().getDia())) {
/////////////////////////////////This is the validation of the first schedule////////////////////////////////
            if (controlVL.getCursos().get(indiceCurso).getHorario1().getHoraInicio()
                    == cursosLab.get(i).getHorario1().getHoraInicio()
                    ||controlVL.getCursos().get(indiceCurso).getHorario1().getHoraInicio()
                    == cursosLab.get(i).getHorario1().getHoraInicio().plusHours(1)
/////////////////////////////this is the validation of the second schedule//////////////////////////////////  
                    ||controlVL.getCursos().get(indiceCurso).getHorario2().getHoraInicio()
                    == cursosLab.get(i).getHorario2().getHoraInicio()
                    ||controlVL.getCursos().get(indiceCurso).getHorario2().getHoraInicio()
                    == cursosLab.get(i).getHorario2().getHoraInicio().plusHours(1)
////////////////////////////this is the validation of the first day////////////////////////////////////////                    
                    && controlVL.getCursos().get(indiceCurso).getHorario1().getDia()
                            .equals(cursosLab.get(i).getHorario1().getDia())
///////////////////////////this is the validation of the second day///////////////////////////////////////                    
                    || controlVL.getCursos().get(indiceCurso).getHorario2().getDia()
                            .equals(cursosLab.get(i).getHorario2().getDia())) {
