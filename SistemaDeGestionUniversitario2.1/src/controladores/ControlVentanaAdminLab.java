 ...
 * @author JORGE
 */
public class ControlVentanaAdminLab {
    ...
    public ControlVentanaAdminLab(ControladorPrincipal controlP, ControladorAdministrador controlA,
...
public void abrirVentana(AdminLab adminLab){
       AdminLab aux = adminLab;
       VentanaUsAdminLab ventanaAL = new VentanaUsAdminLab(controlP, controlA, controlE, controlD, controlUA, controlAL, controlVE, controlVD, controlVA, controlVAL, controlTE, controlTD, controlTA, controlTAL, panelP, panelA, panelIE, panelID, panelIA, panelIAL, ventanaE, ventanaD, ventanaA);
       ventanaAL.setVisible(true);
       ventanaAL.informacionAdminLab(adminLab);
    }
}
