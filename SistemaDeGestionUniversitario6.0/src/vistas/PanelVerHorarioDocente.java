...
public class PanelVerHorarioDocente extends javax.swing.JFrame {
    ...
    private void llenarTablaCursosLunes() {
        ...
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"Id", "Clase", "Periodo"}, cursosLunes.size());
        ...
        for (int i = 0; i < cursosLunes.size(); i++) {
            ...
            modeloCurso.setValueAt(curso.getPeriodo(), i, 2);
        }
    }
    ...
    private void llenarTablaCursosMartes() {
        ...
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"Id", "Clase", "Periodo"}, cursosMartes.size());
    ...
    private void llenarTablaHorarioMartes() {
        ...
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"Id", "Clase", "Periodo"}, cursosMiercoles.size());
    ...
    private void llenarTablaHorarioMiercoles() {
        ...
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"Id", "Clase", "Periodo"}, cursosJueves.size());
    ...
    private void llenarTablaHorarioJueves() {
        ...
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"Id", "Clase", "Periodo"}, cursosViernes.size());
