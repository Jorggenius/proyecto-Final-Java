...
public class VentanaCursos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboJornada.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mañana\t", "Tarde", "Noche" }));
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        String nombreDocen = JComboDocentes.getSelectedItem().toString();
        Docente docente = controlVC.integrarDocente(nombreDocen);
    ...
    private void btnInscribirEstudianteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInscribirEstudianteActionPerformed
       String nombreEstu = JComboEstudiantes.getSelectedItem().toString();
         Estudiante aux = controlVC.inscribirEstudiante(nombreEstu);
         if (aux != null) {
            estsCurso.add(aux);
