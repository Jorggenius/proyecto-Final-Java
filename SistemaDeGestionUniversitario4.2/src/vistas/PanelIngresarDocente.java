...
public class PanelIngresarDocente extends javax.swing.JFrame {
    ...
    public PanelIngresarDocente() {
        ...
        controlD = new ControladorDocente();
        txtId.setText(controlD.contadorId());
    }
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        // TODO add your handling code here:
        TablaDocentes tablaD = new TablaDocentes();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        Date birthDate = datebirthDate.getDate();
        String contraseña = txtContraseña.getText();
        boolean aux = controlD.editarDocente(id, nombre, asignatura, birthDate, contraseña);
        if (aux) {
            JOptionPane.showMessageDialog(null, "Docente editado");
            limpiarCampos();
        } else {
            JOptionPane.showMessageDialog(null, "Imposible editar");
            limpiarCampos();
        }
