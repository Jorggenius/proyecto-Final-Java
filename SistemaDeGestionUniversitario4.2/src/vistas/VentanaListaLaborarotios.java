...
public class VentanaListaLaborarotios extends javax.swing.JFrame {
    ...
    DefaultTableModel modelo = new DefaultTableModel(new String[]{"Docente","Materia","Horainicio1","HoraFinal1","Dia","HoraInicio","HoraFinal","Dia"},controVLL.conseguirLaboratorio(id).getCursos().size());
    ...
    TableModel modeloCurso = tablaCursos.getModel();
        for (int i = 0; i < controVLL.conseguirLaboratorio(id).getCursos().size(); i++) {
            ...
            modeloCurso.setValueAt(curso.getDocente(), i, 0);
