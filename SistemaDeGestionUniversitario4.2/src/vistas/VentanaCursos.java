...
//        txtId.setEnabled(false);
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        String mensajeNotificacionEstudiante = "Usted ha sido inscrto men el curso de "
                + materia + " en la jornada " + jornada + " la cual sera dictada por el docente "
        ...
        String mensajeNotificacionDocente = "Querido docente " + JComboDocentes.getSelectedItem() +
               "usted ha sido seleccionado para dictar el curso de " + materia + " en la jornada " + jornada +  " felicitaciones";
