...
import controladores.ControlPanelVerHorario;
 ...
 * @author JORGE
 */
public class PanelVerHorario extends javax.swing.JFrame {

    ControlPanelVerHorario controlPVH;
     ...
     */
    public PanelVerHorario(Estudiante estudiante) {
        initComponents();
        setLocationRelativeTo(this);
        controlPVH = new ControlPanelVerHorario();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, -4, 470, 540));
    ...
    private void llenarTablaCursosLunes() {
        ArrayList<Curso> cursosLunes = controlPVH.cursosLunes();
    ...
    private void llenarTablaHorarioLunes() {
        ArrayList<Horario> horarioLunes = controlPVH.conseguirHorarioLunes(controlPVH.cursosLunes());
    ...
    private void llenarTablaCursosMartes() {
        ArrayList<Curso> cursosMartes = controlPVH.cursosMartes();
    ...
    private void llenarTablaHorarioMartes() {
        ArrayList<Horario> horarioMartes = controlPVH.conseguirHorarioMartes(controlPVH.cursosMartes());
    ...
    private void llenarTablaCursosMiercoles() {
        ArrayList<Curso> cursosMiercoles = controlPVH.cursosMiercoles();
    ...
    private void llenarTablaHorarioMiercoles() {
        ArrayList<Horario> horarioMiercoles = controlPVH.conseguirHorarioMiercoles(controlPVH.cursosMiercoles());
    ...
    private void llenarTablaCursosJueves() {
        ArrayList<Curso> cursosJueves = controlPVH.cursosJueves();
    ...
    private void llenarTablaHorarioJueves() {
        ArrayList<Horario> horarioJueves = controlPVH.conseguirHorarioJueves(controlPVH.cursosJueves());
    ...
    private void llenarTablaCursosViernes() {
        ArrayList<Curso> cursosViernes = controlPVH.cursosViernes();
    ...
    private void llenarTablaHorarioViernes() {
        ArrayList<Horario> horarioViernes = controlPVH.conseguirHorarioViernes(controlPVH.cursosViernes());
